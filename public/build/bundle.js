    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "The fastest access to your favorite applications.";
    			attr_dev(h1, "class", "svelte-1cp0utu");
    			add_location(h1, file, 25, 2, 341);
    			add_location(p, file, 26, 2, 359);
    			attr_dev(main, "class", "svelte-1cp0utu");
    			add_location(main, file, 24, 0, 332);
    		},
