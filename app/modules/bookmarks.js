...
const bkms = {
  ...
  addBookmarksInUI (id, icon, url, type) {
    ...
    if (type === 'app') {
      navZone.innerHTML += `<a href="#" class="bubble-btn" id="id-${id}" onclick="view.show('${id}', '${url}', 'app')" oncontextmenu="modales.removeApp('${id}', '${type}')" onmouseover="controlBar.show('${id}', true)" style="background-image: url('${icon}'); background-size: 100%;"></a>`
